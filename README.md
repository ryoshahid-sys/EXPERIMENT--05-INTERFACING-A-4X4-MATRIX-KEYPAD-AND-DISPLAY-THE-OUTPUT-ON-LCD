...
void key()
{
	 Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
		  	    ...
		  	    col2 =HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_5);
		  	    col3 =HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_6);
		  	    col4 =HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_7);	if(!col1)
		  	      	{
		  	      		Lcd_cursor(&lcd,0,1);
		  	      		Lcd_string(&lcd, "key4\n");
		  	      		col1=1;
...
## Output screen shots of proteus  :
 <img width="1530" height="906" alt="Screenshot 2026-08-28 190852" src="https://github.com/user-attachments/assets/0b55576d-4cdf-4a6d-84b6-cb51d99b4600" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="843" height="845" alt="Screenshot 2026-08-28 190923" src="https://github.com/user-attachments/assets/04c1765f-ecaa-433d-9ecb-cf2907018b9d" />
